...
mod json_tests {
    ...
    mod json_test_suite {
        ...
        fn transformation_numbers() {
            let number_10 = read_json("data/json/json-test-data/jsonTestSuite-data/i_test_transform/number_1.0.json").unwrap();
            ...
            assert_eq!(number_1000000000000000005.as_array().unwrap()[0].as_float().unwrap(), &1.0);
            let number_1e6 = read_json("data/json/json-test-data/jsonTestSuite-data/i_test_transform/number_1e6.json").unwrap();
            assert_eq!(number_1e6.as_array().unwrap()[0].as_float().unwrap(), &1000000.0);
            let number_1e_999 = read_json("data/json/json-test-data/jsonTestSuite-data/i_test_transform/number_1e-999.json").unwrap();
            assert_eq!(number_1e_999.as_array().unwrap()[0].as_float().unwrap(), &0.0);
            ...
            assert_eq!(number_1000000000000000.as_array().unwrap()[0].as_uint().unwrap(), &1000000000000000);
            ...
            assert_eq!(number_9223372036854775807.as_array().unwrap()[0].as_uint().unwrap(), &9223372036854775807);
            ...
            assert_eq!(number_9223372036854775808.as_array().unwrap()[0].as_uint().unwrap(), &9223372036854775808);
            ...
            assert_eq!(number_10000000000000000999.as_array().unwrap()[0].as_uint().unwrap(), &10000000000000000999);
            ...
            assert_eq!(number_min_9223372036854775808.as_array().unwrap()[0].as_int().unwrap(), &-9223372036854775808);
            ...
            assert_eq!(number_min_9223372036854775809.as_array().unwrap()[0].as_float().unwrap(), &-9223372036854776e3);
        ...
        fn transformation_objects() {
            ...
            assert_eq!(object_same_key_different_values.as_object().unwrap().len(), 1);
            assert!(object_same_key_different_values.as_object().unwrap().get("a").unwrap().as_uint().unwrap() == &2);
            ...
            assert!(object_same_key_same_value.as_object().unwrap().get("a").unwrap().as_uint().unwrap() == &1);
            ...
            assert!(object_same_key_unclear_value.as_object().unwrap().get("a").unwrap().as_int().unwrap() == &0);
        }
        ...
        fn implementor_dependent_numbers() {
            ...
            assert_eq!(number_double_huge_neg_exp.as_array().unwrap()[0].is_number(), true);
            assert!(number_double_huge_neg_exp.as_array().unwrap()[0].as_float().unwrap() == &0.0);
            ...
            assert!(number_real_underflow.as_array().unwrap()[0].as_float().unwrap() == &0.0);
            // I don't accept overflow to infinity - documented
            let number_huge_exp = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/i_number_huge_exp.json").unwrap();
            ...
            assert!(number_too_big_neg_int.as_array().unwrap()[0].as_float().unwrap() == &-1.2312312312312312e29);
            ...
            assert!(number_too_big_pos_int.as_array().unwrap()[0].as_float().unwrap() == &1e20);
            ...
            assert!(number_very_big_negative_int.as_array().unwrap()[0].as_float().unwrap() == &-2.374623746732769e47);
        }
        ...
        fn valid_strings() {
            ...
            let string_comments = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_comments.json").unwrap();
            ...
            let string_in_array = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_in_array.json").unwrap();
            assert!(string_in_array.as_array().unwrap()[0].is_string());
            assert_eq!(string_in_array.as_array().unwrap()[0].as_str().unwrap(), "asd");
            ...
            assert_eq!(string_in_array_with_leading_space.as_array().unwrap()[0].as_str().unwrap(), "asd");
            ...
            assert_eq!(string_nbsp_uescaped.as_array().unwrap()[0].as_str().unwrap(), "new\u{00A0}line");
            ...
            let string_pi = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_pi.json").unwrap();
            ...
            assert!(string_reservedcharacterinutf_8_uplus1bfff.as_array().unwrap()[0].is_string());
            ...
            assert_eq!(string_simple_ascii.as_array().unwrap()[0].as_str().unwrap(), "asd ");
            let string_space = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_space.json").unwrap();
            ...
            assert_eq!(string_three_byte_utf8.as_array().unwrap()[0].as_str().unwrap(), "\u{0821}");
            ...
            assert_eq!(string_two_byte_utf8.as_array().unwrap()[0].as_str().unwrap(), "\u{0123}");
            ...
            let string_uescape = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_uEscape.json").unwrap();
            ...
            let string_unicode = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_unicode.json").unwrap();
            assert!(string_unicode.as_array().unwrap()[0].is_string());
            let string_unicode2 = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_unicode_2.json").unwrap();
            ...
            assert!(string_unicode_uplus200b_zero_width_space.as_array().unwrap()[0].is_string());
            ...
            let string_utf8 = read_json("data/json/json-test-data/jsonTestSuite-data/test_parsing/y_string_utf8.json").unwrap();
